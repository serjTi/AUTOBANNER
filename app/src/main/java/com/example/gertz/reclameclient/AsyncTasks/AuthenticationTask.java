...
public class AuthenticationTask extends AsyncTask<String, Void, String> {
    ...
    public AuthenticationTask(AuthResponse listener) {
        delegate = listener;
    }
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            nameValuePairs.add(new BasicNameValuePair(Constants.EMAIL, params[0]));
            nameValuePairs.add(new BasicNameValuePair(Constants.PASSWORD, params[1]));
            httpPost = new HttpPost(Constants.AUTHENTICATION_URL);
